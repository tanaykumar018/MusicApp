...
extension UICollectionView {
    func dequeueReusableCell<T: UICollectionViewCell>(for indexPath: IndexPath) -> T where T: StoryboardIdentifiable {
    ...
    func cellForItem<T: UICollectionViewCell>(at indexPath: IndexPath) -> T where T: StoryboardIdentifiable {
